...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-90e0000').click(function () {
           $('html, body').animate({scrollTop: $('#js--90e0000').offset().top -20}, 1000);
          });

          $('.js--sc-90e0100').click(function () {
           $('html, body').animate({scrollTop: $('#js--90e0100').offset().top -20}, 1000);
          });

          $('.js--sc-90e0101').click(function () {
           $('html, body').animate({scrollTop: $('#js--90e0101').offset().top -20}, 1000);
          });

          $('.js--sc-90e0102').click(function () {
           $('html, body').animate({scrollTop: $('#js--90e0102').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-f90e-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90e-01').offset().top -80}, 1000);
          });

          $('.js--sc-f90e-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90e-02').offset().top -80}, 1000);
          });

          $('.js--sc-f90e-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90e-03').offset().top -80}, 1000);
          });

          $('.js--sc-f90e-04').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90e-04').offset().top -80}, 1000);
          });

          $('.js--sc-f90e-05').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90e-05 ').offset().top -80}, 1000);
          });

          $('.js--sc-f90e-06').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90e-06').offset().top -80}, 1000);
          });

          $('.js--sc-f90e-07').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90e-07').offset().top -80}, 1000);
          });

          $('.js--sc-f90e-08').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90e-08').offset().top -80}, 1000);
          });
