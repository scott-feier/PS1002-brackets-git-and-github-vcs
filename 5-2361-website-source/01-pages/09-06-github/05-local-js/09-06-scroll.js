...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          09-06-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
05 Sep 2017   d-P12.09.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P12.09.01</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-090600').click(function () {
           $('html, body').animate({scrollTop: $('#js--090600').offset().top -20}, 1000);
          });

          $('.js--sc-090601').click(function () {
           $('html, body').animate({scrollTop: $('#js--090601').offset().top -20}, 1000);
          });

          $('.js--sc-090602').click(function () {
           $('html, body').animate({scrollTop: $('#js--090602').offset().top -20}, 1000);
          });

          $('.js--sc-090603').click(function () {
           $('html, body').animate({scrollTop: $('#js--090603').offset().top -20}, 1000);
          });

          $('.js--sc-090604').click(function () {
           $('html, body').animate({scrollTop: $('#js--090604').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f09-80').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-80').offset().top -80}, 1000);
          });

          $('.js--sc-f09-81').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-81').offset().top -80}, 1000);
          });

          $('.js--sc-f09-82').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-82').offset().top -80}, 1000);
          });

          $('.js--sc-f09-83').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-83').offset().top -80}, 1000);
          });

          $('.js--sc-f09-84').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-84').offset().top -80}, 1000);
          });

          $('.js--sc-f09-85').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-85').offset().top -80}, 1000);
          });

          $('.js--sc-f09-86').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-86').offset().top -80}, 1000);
          });

          $('.js--sc-f09-87').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-87').offset().top -80}, 1000);
          });

          $('.js--sc-f09-88').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-88').offset().top -80}, 1000);
          });

          $('.js--sc-f09-89').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-89').offset().top -80}, 1000);
          });

          $('.js--sc-f09-90').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-90').offset().top -80}, 1000);
          });

          $('.js--sc-f09-91').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-91').offset().top -80}, 1000);
          });
