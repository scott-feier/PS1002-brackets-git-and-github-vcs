...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          02-09-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
15 Jul 2017   d-P02.02.05  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P02.02.05</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-020900').click(function () {
           $('html, body').animate({scrollTop: $('#js--020900').offset().top -20}, 1000);
          });

          $('.js--sc-020901').click(function () {
           $('html, body').animate({scrollTop: $('#js--020901').offset().top -20}, 1000);
          });

          $('.js--sc-020902').click(function () {
           $('html, body').animate({scrollTop: $('#js--020902').offset().top -20}, 1000);
          });
          ...
          $('.js--sc-020903').click(function () {
           $('html, body').animate({scrollTop: $('#js--020903').offset().top -20}, 1000);
          });

          $('.js--sc-020904').click(function () {
           $('html, body').animate({scrollTop: $('#js--020904').offset().top -20}, 1000);
          });

          $('.js--sc-020905').click(function () {
           $('html, body').animate({scrollTop: $('#js--020905').offset().top -20}, 1000);
          });

          $('.js--sc-020906').click(function () {
           $('html, body').animate({scrollTop: $('#js--020906').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f02-27').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-27').offset().top -80}, 1000);
          });

          $('.js--sc-f02-28').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-28').offset().top -80}, 1000);
          });

          $('.js--sc-f02-29').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-29').offset().top -80}, 1000);
          });

          $('.js--sc-f02-30').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-30').offset().top -80}, 1000);
          });
