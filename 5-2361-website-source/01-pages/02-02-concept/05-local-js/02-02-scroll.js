...
-------------------------------------------------------------------------------
11 Jun 2017   d-P02.02.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P02.02.01</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-020200').click(function () {
           $('html, body').animate({scrollTop: $('#js--020200').offset().top -20}, 1000);
          });

          $('.js--sc-020201').click(function () {
           $('html, body').animate({scrollTop: $('#js--020201').offset().top -20}, 1000);
          });

          $('.js--sc-020202').click(function () {
           $('html, body').animate({scrollTop: $('#js--020202').offset().top -20}, 1000);
          });

          $('.js--sc-020203').click(function () {
           $('html, body').animate({scrollTop: $('#js--020203').offset().top -20}, 1000);
          });

          $('.js--sc-020204').click(function () {
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-f02-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-01').offset().top -80}, 1000);
          });

          $('.js--sc-f02-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-02').offset().top -80}, 1000);
          });

          $('.js--sc-f02-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-03').offset().top -80}, 1000);
          });

          $('.js--sc-f02-04').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-04').offset().top -80}, 1000);
          });

          $('.js--sc-f02-05').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-05').offset().top -80}, 1000);
          });

          $('.js--sc-f02-06').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-06').offset().top -80}, 1000);
          });

          $('.js--sc-f02-07').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-07').offset().top -80}, 1000);
          });

          $('.js--sc-f02-08').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-08').offset().top -80}, 1000);
          });

          $('.js--sc-f02-09').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-09').offset().top -80}, 1000);
          });

          $('.js--sc-f02-10').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-10').offset().top -80}, 1000);
          });

          $('.js--sc-f02-11').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-11').offset().top -80}, 1000);
          });

          $('.js--sc-c02-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--c02-01').offset().top -100}, 1000);
          });

          $('.js--sc-c02-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--c02-02').offset().top -100}, 1000);
          });

          $('.js--sc-c02-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--c02-03').offset().top -100}, 1000);
          });
