...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P13.10.01</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-100201').click(function () {
           $('html, body').animate({scrollTop: $('#js--100201').offset().top -20}, 1000);
          });

          $('.js--sc-100202').click(function () {
           $('html, body').animate({scrollTop: $('#js--100202').offset().top -20}, 1000);
          });

          $('.js--sc-100203').click(function () {
           $('html, body').animate({scrollTop: $('#js--100203').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-f10-24').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-24').offset().top -80}, 1000);
          });

          $('.js--sc-f10-25').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-25').offset().top -80}, 1000);
          });

          $('.js--sc-f10-26').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-26').offset().top -80}, 1000);
          });

          $('.js--sc-f10-27').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-27').offset().top -80}, 1000);
          });

          $('.js--sc-f10-28').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-28').offset().top -80}, 1000);
          });

          $('.js--sc-f10-29').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-29').offset().top -80}, 1000);
          });

          $('.js--sc-f10-30').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-30').offset().top -80}, 1000);
          });

          $('.js--sc-f10-31').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-31').offset().top -80}, 1000);
          });

          $('.js--sc-f10-32').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-32').offset().top -80}, 1000);
          });

          $('.js--sc-f10-33').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-33').offset().top -80}, 1000);
          });

          $('.js--sc-f10-34').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-34').offset().top -80}, 1000);
          });

          $('.js--sc-f10-35').click(function () {
           $('html, body').animate({scrollTop: $('#js--f10-35').offset().top -80}, 1000);
          });
