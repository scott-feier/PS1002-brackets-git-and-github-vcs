...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          06-05-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-060500').click(function () {
           $('html, body').animate({scrollTop: $('#js--060500').offset().top -20}, 1000);
          });

          $('.js--sc-060501').click(function () {
           $('html, body').animate({scrollTop: $('#js--060501').offset().top -20}, 1000);
          });

          $('.js--sc-060502').click(function () {
           $('html, body').animate({scrollTop: $('#js--060502').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f06-44').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-44').offset().top -80}, 1000);
          });

          $('.js--sc-f06-45').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-45').offset().top -80}, 1000);
          });

          $('.js--sc-f06-46').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-46').offset().top -80}, 1000);
          });

          $('.js--sc-f06-47').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-47').offset().top -80}, 1000);
          });

          $('.js--sc-f06-48').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-48').offset().top -80}, 1000);
          });

          $('.js--sc-f06-49').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-49').offset().top -80}, 1000);
          });
