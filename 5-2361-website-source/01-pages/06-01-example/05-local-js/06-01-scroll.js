...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          06-01-SCROLL.JS
*******************************************************************************
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P09.06.01</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f06-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-01').offset().top -80}, 1000);
          });

          $('.js--sc-f06-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-02').offset().top -80}, 1000);
          });

          $('.js--sc-f06-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-03').offset().top -80}, 1000);
          });

          $('.js--sc-f06-04').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-04').offset().top -80}, 1000);
          });

          $('.js--sc-f06-05').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-05').offset().top -80}, 1000);
          });

          $('.js--sc-f06-06').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-06').offset().top -80}, 1000);
          });

          $('.js--sc-f06-07').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-07').offset().top -80}, 1000);
          });
