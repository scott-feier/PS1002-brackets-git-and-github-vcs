...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-090100').click(function () {
           $('html, body').animate({scrollTop: $('#js--090100').offset().top -20}, 1000);
          });

          $('.js--sc-090101').click(function () {
           $('html, body').animate({scrollTop: $('#js--090101').offset().top -20}, 1000);
          });

          $('.js--sc-090102').click(function () {
           $('html, body').animate({scrollTop: $('#js--090102').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f09-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-01').offset().top -80}, 1000);
          });

          $('.js--sc-f09-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-02').offset().top -80}, 1000);
          });

          $('.js--sc-f09-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-03').offset().top -80}, 1000);
          });
