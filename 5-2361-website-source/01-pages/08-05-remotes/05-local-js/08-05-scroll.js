...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          08-05-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
01 Sep 2017   d-P11.08.02  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P11.08.02</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-080500').click(function () {
           $('html, body').animate({scrollTop: $('#js--080500').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f08-47').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-47').offset().top -80}, 1000);
          });

          $('.js--sc-f08-48').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-48').offset().top -80}, 1000);
          });

          $('.js--sc-f08-49').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-49').offset().top -80}, 1000);
          });

          $('.js--sc-f08-50').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-50').offset().top -80}, 1000);
          });

          $('.js--sc-f08-51').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-51').offset().top -80}, 1000);
          });

          $('.js--sc-f08-52').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-52').offset().top -80}, 1000);
          });

          $('.js--sc-f08-53').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-53').offset().top -80}, 1000);
          });

          $('.js--sc-f08-54').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-54').offset().top -80}, 1000);
          });

          $('.js--sc-f08-55').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-55').offset().top -80}, 1000);
          });

          $('.js--sc-f08-56').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-56').offset().top -80}, 1000);
          });

          $('.js--sc-f08-57').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-57').offset().top -80}, 1000);
          });

          $('.js--sc-f08-58').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-58').offset().top -80}, 1000);
          });

          $('.js--sc-f08-59').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-59').offset().top -80}, 1000);
          });

          $('.js--sc-f08-60').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-60').offset().top -80}, 1000);
          });

          $('.js--sc-f08-61').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-61').offset().top -80}, 1000);
          });

          $('.js--sc-f08-62').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-62').offset().top -80}, 1000);
          });
