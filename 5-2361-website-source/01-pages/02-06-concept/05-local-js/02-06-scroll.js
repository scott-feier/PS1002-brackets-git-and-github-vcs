...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          02-06-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-020600').click(function () {
           $('html, body').animate({scrollTop: $('#js--020600').offset().top -20}, 1000);
          });

          $('.js--sc-020601').click(function () {
           $('html, body').animate({scrollTop: $('#js--020601').offset().top -20}, 1000);
          });

          $('.js--sc-020602').click(function () {
           $('html, body').animate({scrollTop: $('#js--020602').offset().top -20}, 1000);
          });
          ...
          $('.js--sc-020603').click(function () {
           $('html, body').animate({scrollTop: $('#js--020603').offset().top -20}, 1000);
          });

          $('.js--sc-020604').click(function () {
           $('html, body').animate({scrollTop: $('#js--020604').offset().top -20}, 1000);
          });
