...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          03-04-SCROLL.JS
*******************************************************************************
...
31 Jul 2018   d-R01-00-02  M. Gledhill    Figure numbers changed

23 Sep 2017   R01          M. Gledhill    First formal release

26 Jul 2017   P04          M. Gledhill    Published

24 Jul 2017   d-P03.03.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-030403').click(function () {
           $('html, body').animate({scrollTop: $('#js--030403').offset().top -20}, 1000);
          });

          $('.js--sc-030404').click(function () {
           $('html, body').animate({scrollTop: $('#js--030404').offset().top -20}, 1000);
          });

          $('.js--sc-030405').click(function () {
           $('html, body').animate({scrollTop: $('#js--030405').offset().top -20}, 1000);
          });
