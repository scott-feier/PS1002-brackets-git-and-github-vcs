...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          08-01-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
22 Aug 2017   d-P11.08.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P11.08.01</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-080100').click(function () {
           $('html, body').animate({scrollTop: $('#js--080100').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f08-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-01').offset().top -80}, 1000);
          });

          $('.js--sc-f08-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-02').offset().top -80}, 1000);
          });

          $('.js--sc-f08-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-03').offset().top -80}, 1000);
          });

          $('.js--sc-f08-04').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-04').offset().top -80}, 1000);
          });

          $('.js--sc-f08-05').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-05').offset().top -80}, 1000);
          });

          $('.js--sc-f08-06').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-06').offset().top -80}, 1000);
          });
