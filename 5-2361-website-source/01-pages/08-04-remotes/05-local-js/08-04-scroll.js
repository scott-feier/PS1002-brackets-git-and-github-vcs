...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-080400').click(function () {
           $('html, body').animate({scrollTop: $('#js--080400').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f08-32').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-32').offset().top -80}, 1000);
          });

          $('.js--sc-f08-33').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-33').offset().top -80}, 1000);
          });

          $('.js--sc-f08-34').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-34').offset().top -80}, 1000);
          });

          $('.js--sc-f08-35').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-35').offset().top -80}, 1000);
          });

          $('.js--sc-f08-36').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-36').offset().top -80}, 1000);
          });

          $('.js--sc-f08-37').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-37').offset().top -80}, 1000);
          });

          $('.js--sc-f08-38').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-38').offset().top -80}, 1000);
          });

          $('.js--sc-f08-39').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-39').offset().top -80}, 1000);
          });

          $('.js--sc-f08-40').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-40').offset().top -80}, 1000);
          });

          $('.js--sc-f08-41').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-41').offset().top -80}, 1000);
          });

          $('.js--sc-f08-42').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-42').offset().top -80}, 1000);
          });

          $('.js--sc-f08-43').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-43').offset().top -80}, 1000);
          });

          $('.js--sc-f08-44').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-44').offset().top -80}, 1000);
          });

          $('.js--sc-f08-45').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-45').offset().top -80}, 1000);
          });

          $('.js--sc-f08-46').click(function () {
           $('html, body').animate({scrollTop: $('#js--f08-46').offset().top -80}, 1000);
          });
