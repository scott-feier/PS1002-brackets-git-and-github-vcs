...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          09-02-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
03 Sep 2017   d-P12.09.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-090200').click(function () {
           $('html, body').animate({scrollTop: $('#js--090200').offset().top -20}, 1000);
          });

          $('.js--sc-090201').click(function () {
           $('html, body').animate({scrollTop: $('#js--090201').offset().top -20}, 1000);
          });

          $('.js--sc-090202').click(function () {
           $('html, body').animate({scrollTop: $('#js--090202').offset().top -20}, 1000);
          });

          $('.js--sc-090203').click(function () {
           $('html, body').animate({scrollTop: $('#js--090203').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f09-04').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-04').offset().top -80}, 1000);
          });

          $('.js--sc-f09-05').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-05').offset().top -80}, 1000);
          });

          $('.js--sc-f09-06').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-06').offset().top -80}, 1000);
          });

          $('.js--sc-f09-07').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-07').offset().top -80}, 1000);
          });

          $('.js--sc-f09-08').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-08').offset().top -80}, 1000);
          });

          $('.js--sc-f09-09').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-09').offset().top -80}, 1000);
          });

          $('.js--sc-f09-10').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-10').offset().top -80}, 1000);
          });

          $('.js--sc-f09-11').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-11').offset().top -80}, 1000);
          });

          $('.js--sc-f09-12').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-12').offset().top -80}, 1000);
          });

          $('.js--sc-f09-013').click(function () {
