...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          07-02-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
20 Aug 2017   d-P10.07.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P10.07.01</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-070200').click(function () {
           $('html, body').animate({scrollTop: $('#js--070200').offset().top -20}, 1000);
          });

          $('.js--sc-070201').click(function () {
           $('html, body').animate({scrollTop: $('#js--070201').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f07-04').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-04').offset().top -80}, 1000);
          });

          $('.js--sc-f07-05').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-05').offset().top -80}, 1000);
          });

          $('.js--sc-f07-06').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-06').offset().top -80}, 1000);
          });

          $('.js--sc-f07-07').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-07').offset().top -80}, 1000);
          });

          $('.js--sc-f07-08').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-08').offset().top -80}, 1000);
          });

          $('.js--sc-f07-09').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-09').offset().top -80}, 1000);
          });

          $('.js--sc-f07-10').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-10').offset().top -80}, 1000);
          });

          $('.js--sc-f07-11').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-11').offset().top -80}, 1000);
          });

          $('.js--sc-f07-12').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-12').offset().top -80}, 1000);
          });

          $('.js--sc-f07-13').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-13').offset().top -80}, 1000);
          });

          $('.js--sc-f07-14').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-14').offset().top -80}, 1000);
          });

          $('.js--sc-f07-15').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-15').offset().top -80}, 1000);
          });
