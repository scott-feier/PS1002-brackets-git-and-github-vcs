...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          90-00-SCROLL.JS
*******************************************************************************
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P14.90.01</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-900000').click(function () {
           $('html, body').animate({scrollTop: $('#js--900000').offset().top -20}, 1000);
          });
