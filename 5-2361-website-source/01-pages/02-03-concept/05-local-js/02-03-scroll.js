...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          02-01-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
11 Jun 2017   d-P02.02.02  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P02.02.02</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-020300').click(function () {
           $('html, body').animate({scrollTop: $('#js--020300').offset().top -20}, 1000);
          });

          $('.js--sc-020301').click(function () {
           $('html, body').animate({scrollTop: $('#js--020301').offset().top -20}, 1000);
          });

          $('.js--sc-020302').click(function () {
           $('html, body').animate({scrollTop: $('#js--020302').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-f02-12').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-12').offset().top -80}, 1000);
          });

          $('.js--sc-f02-13').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-13').offset().top -80}, 1000);
          });

          $('.js--sc-f02-14').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-14').offset().top -80}, 1000);
          });

          $('.js--sc-f02-15').click(function () {
           $('html, body').animate({scrollTop: $('#js--f02-15').offset().top -80}, 1000);
          });
          ...
          $('.js--sc-c02-04').click(function () {
           $('html, body').animate({scrollTop: $('#js--c02-04').offset().top -100}, 1000);
          });
