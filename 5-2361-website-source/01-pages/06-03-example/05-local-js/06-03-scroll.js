...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          06-03-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
15 Aug 2017   d-P09.06.02  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P09.06.02</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-060300').click(function () {
           $('html, body').animate({scrollTop: $('#js--060300').offset().top -20}, 1000);
          });

          $('.js--sc-060301').click(function () {
           $('html, body').animate({scrollTop: $('#js--060301').offset().top -20}, 1000);
          });

          $('.js--sc-060302').click(function () {
           $('html, body').animate({scrollTop: $('#js--060302').offset().top -20}, 1000);
          });

          $('.js--sc-060303').click(function () {
           $('html, body').animate({scrollTop: $('#js--060303').offset().top -20}, 1000);
          });

          $('.js--sc-060304').click(function () {
           $('html, body').animate({scrollTop: $('#js--060304').offset().top -20}, 1000);
          });

          $('.js--sc-060305').click(function () {
           $('html, body').animate({scrollTop: $('#js--060305').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f06-20').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-20').offset().top -80}, 1000);
          });

          $('.js--sc-f06-21').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-21').offset().top -80}, 1000);
          });

          $('.js--sc-f06-22').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-22').offset().top -80}, 1000);
          });

          $('.js--sc-f06-23').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-23').offset().top -80}, 1000);
          });

          $('.js--sc-f06-24').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-24').offset().top -80}, 1000);
          });

          $('.js--sc-f06-25').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-25').offset().top -80}, 1000);
          });

          $('.js--sc-f06-26').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-26').offset().top -80}, 1000);
          });

          $('.js--sc-f06-27').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-27').offset().top -80}, 1000);
          });

          $('.js--sc-f06-28').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-28').offset().top -80}, 1000);
          });

          $('.js--sc-f06-29').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-29').offset().top -80}, 1000);
          });

          $('.js--sc-f06-30').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-30').offset().top -80}, 1000);
          });

          $('.js--sc-f06-31').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-31').offset().top -80}, 1000);
          });

          $('.js--sc-f06-32').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-32').offset().top -80}, 1000);
          });

          $('.js--sc-f06-33').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-33').offset().top -80}, 1000);
          });

          $('.js--sc-f06-34').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-34').offset().top -80}, 1000);
          });

          $('.js--sc-f06-35').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-35').offset().top -80}, 1000);
          });
