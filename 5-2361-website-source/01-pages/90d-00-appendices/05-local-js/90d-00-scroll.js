...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                         90d-00-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-90d0000').click(function () {
           $('html, body').animate({scrollTop: $('#js--90d0000').offset().top -20}, 1000);
          });

          $('.js--sc-90d0100').click(function () {
           $('html, body').animate({scrollTop: $('#js--90d0100').offset().top -20}, 1000);
          });

          $('.js--sc-90d0200').click(function () {
           $('html, body').animate({scrollTop: $('#js--90d0200').offset().top -20}, 1000);
          });
