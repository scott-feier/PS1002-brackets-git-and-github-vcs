...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-090400').click(function () {
           $('html, body').animate({scrollTop: $('#js--090400').offset().top -20}, 1000);
          });

          $('.js--sc-090401').click(function () {
           $('html, body').animate({scrollTop: $('#js--090401').offset().top -20}, 1000);
          });

          $('.js--sc-090402').click(function () {
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f09-33').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-33').offset().top -80}, 1000);
          });

          $('.js--sc-f09-34').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-34').offset().top -80}, 1000);
          });

          $('.js--sc-f09-35').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-35').offset().top -80}, 1000);
          });

          $('.js--sc-f09-36').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-36').offset().top -80}, 1000);
          });

          $('.js--sc-f09-37').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-37').offset().top -80}, 1000);
          });

          $('.js--sc-f09-38').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-38').offset().top -80}, 1000);
          });

          $('.js--sc-f09-39').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-39').offset().top -80}, 1000);
          });

          $('.js--sc-f09-40').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-40').offset().top -80}, 1000);
          });

          $('.js--sc-f09-41').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-41').offset().top -80}, 1000);
          });

          $('.js--sc-f09-42').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-42').offset().top -80}, 1000);
          });

          $('.js--sc-f09-43').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-43').offset().top -80}, 1000);
          });

          $('.js--sc-f09-44').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-44').offset().top -80}, 1000);
          });

          $('.js--sc-f09-45').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-45').offset().top -80}, 1000);
          });

          $('.js--sc-f09-46').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-46').offset().top -80}, 1000);
          });

          $('.js--sc-f09-47').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-47').offset().top -80}, 1000);
          });

          $('.js--sc-f09-48').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-48').offset().top -80}, 1000);
          });
