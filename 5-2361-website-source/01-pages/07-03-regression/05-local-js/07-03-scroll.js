...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          07-03-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
21 Aug 2017   d-P10.07.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-070300').click(function () {
           $('html, body').animate({scrollTop: $('#js--070300').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f07-16').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-16').offset().top -80}, 1000);
          });

          $('.js--sc-f07-17').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-17').offset().top -80}, 1000);
          });

          $('.js--sc-f07-18').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-18').offset().top -80}, 1000);
          });

          $('.js--sc-f07-19').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-19').offset().top -80}, 1000);
          });

          $('.js--sc-f07-20').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-20').offset().top -80}, 1000);
          });

          $('.js--sc-f07-21').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-21').offset().top -80}, 1000);
          });

          $('.js--sc-f07-22').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-22').offset().top -80}, 1000);
          });

          $('.js--sc-f07-23').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-23').offset().top -80}, 1000);
          });

          $('.js--sc-f07-24').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-24').offset().top -80}, 1000);
          });
