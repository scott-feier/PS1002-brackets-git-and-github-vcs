...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          09-03-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-090300').click(function () {
           $('html, body').animate({scrollTop: $('#js--090300').offset().top -20}, 1000);
          });

          $('.js--sc-090301').click(function () {
           $('html, body').animate({scrollTop: $('#js--090301').offset().top -20}, 1000);
          });

          $('.js--sc-090302').click(function () {
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f09-20').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-20').offset().top -80}, 1000);
          });

          $('.js--sc-f09-21').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-21').offset().top -80}, 1000);
          });

          $('.js--sc-f09-22').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-22').offset().top -80}, 1000);
          });

          $('.js--sc-f09-23').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-23').offset().top -80}, 1000);
          });

          $('.js--sc-f09-24').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-24').offset().top -80}, 1000);
          });

          $('.js--sc-f09-25').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-25').offset().top -80}, 1000);
          });

          $('.js--sc-f09-26').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-26').offset().top -80}, 1000);
          });

          $('.js--sc-f09-27').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-27').offset().top -80}, 1000);
          });

          $('.js--sc-f09-28').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-28').offset().top -80}, 1000);
          });

          $('.js--sc-f09-29').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-29').offset().top -80}, 1000);
          });

          $('.js--sc-f09-30').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-30').offset().top -80}, 1000);
          });

          $('.js--sc-f09-31').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-31').offset().top -80}, 1000);
          });

          $('.js--sc-f09-32').click(function () {
           $('html, body').animate({scrollTop: $('#js--f09-32').offset().top -80}, 1000);
          });
