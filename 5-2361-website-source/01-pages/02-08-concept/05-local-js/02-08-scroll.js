...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          02-08-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-020800').click(function () {
           $('html, body').animate({scrollTop: $('#js--020800').offset().top -20}, 1000);
          });

          $('.js--sc-020801').click(function () {
           $('html, body').animate({scrollTop: $('#js--020801').offset().top -20}, 1000);
          });

          $('.js--sc-020802').click(function () {
           $('html, body').animate({scrollTop: $('#js--020802').offset().top -20}, 1000);
          });
