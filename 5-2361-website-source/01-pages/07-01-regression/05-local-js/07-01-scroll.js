...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          07-01-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-070100').click(function () {
           $('html, body').animate({scrollTop: $('#js--070100').offset().top -20}, 1000);
          });

          $('.js--sc-070101').click(function () {
           $('html, body').animate({scrollTop: $('#js--070101').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f07-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-01').offset().top -80}, 1000);
          });

          $('.js--sc-f07-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-02').offset().top -80}, 1000);
          });

          $('.js--sc-f07-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--f07-03').offset().top -80}, 1000);
          });
