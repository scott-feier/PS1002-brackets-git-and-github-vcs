...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          06-04-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
16 Aug 2017   d-P09.06.02  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-060400').click(function () {
           $('html, body').animate({scrollTop: $('#js--060400').offset().top -20}, 1000);
          });

          $('.js--sc-060401').click(function () {
           $('html, body').animate({scrollTop: $('#js--060401').offset().top -20}, 1000);
          });

          $('.js--sc-060402').click(function () {
           $('html, body').animate({scrollTop: $('#js--060402').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f06-36').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-36').offset().top -80}, 1000);
          });

          $('.js--sc-f06-37').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-37').offset().top -80}, 1000);
          });

          $('.js--sc-f06-38').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-38').offset().top -80}, 1000);
          });

          $('.js--sc-f06-39').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-39').offset().top -80}, 1000);
          });
          $('.js--sc-f06-40').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-40').offset().top -80}, 1000);
          });
          $('.js--sc-f06-41').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-41').offset().top -80}, 1000);
          });
          $('.js--sc-f06-42').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-42').offset().top -80}, 1000);
          });
          $('.js--sc-f06-43').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-43').offset().top -80}, 1000);
          });
