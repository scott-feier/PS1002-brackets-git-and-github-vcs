...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                         90b-00-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-90b0000').click(function () {
           $('html, body').animate({scrollTop: $('#js--90b0000').offset().top -20}, 1000);
          });

          $('.js--sc-90b0100').click(function () {
           $('html, body').animate({scrollTop: $('#js--90b0100').offset().top -20}, 1000);
          });

          $('.js--sc-90b0200').click(function () {
           $('html, body').animate({scrollTop: $('#js--90b0200').offset().top -20}, 1000);
          });

          $('.js--sc-90b0300').click(function () {
           $('html, body').animate({scrollTop: $('#js--90b0300').offset().top -20}, 1000);
          });

          $('.js--sc-90b0400').click(function () {
           $('html, body').animate({scrollTop: $('#js--90b0400').offset().top -20}, 1000);
          });

          $('.js--sc-90b0500').click(function () {
           $('html, body').animate({scrollTop: $('#js--90b0500').offset().top -20}, 1000);
          });

          $('.js--sc-90b0600').click(function () {
           $('html, body').animate({scrollTop: $('#js--90b0600').offset().top -20}, 1000);
          });

          $('.js--sc-90b0700').click(function () {
           $('html, body').animate({scrollTop: $('#js--90b0700').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-f90b-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90b-01').offset().top -80}, 1000);
          });

          $('.js--sc-f90b-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90b-02').offset().top -80}, 1000);
          });

          $('.js--sc-f90b-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90b-03').offset().top -80}, 1000);
          });

          $('.js--sc-f90b-04').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90b-04').offset().top -80}, 1000);
          });

          $('.js--sc-f90b-05').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90b-05').offset().top -80}, 1000);
          });

          $('.js--sc-t90b-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--t90b-01').offset().top -60}, 1000);
          });
