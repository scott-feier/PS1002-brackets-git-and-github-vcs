...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                         90a-00-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-90a0000').click(function () {
           $('html, body').animate({scrollTop: $('#js--90a0000').offset().top -20}, 1000);
          });

          $('.js--sc-90a0100').click(function () {
           $('html, body').animate({scrollTop: $('#js--90a0100').offset().top -20}, 1000);
          });

          $('.js--sc-90a0101').click(function () {
           $('html, body').animate({scrollTop: $('#js--90a0101').offset().top -20}, 1000);
          });

          $('.js--sc-90a0200').click(function () {
           $('html, body').animate({scrollTop: $('#js--90a0200').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-f90a-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90a-01').offset().top -80}, 1000);
          });

          $('.js--sc-f90a-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90a-02').offset().top -80}, 1000);
          });

          $('.js--sc-f90a-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90a-03').offset().top -80}, 1000);
          });

          $('.js--sc-f90a-04').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90a-04').offset().top -80}, 1000);
          });

          $('.js--sc-f90a-05').click(function () {
           $('html, body').animate({scrollTop: $('#js--f90a-05').offset().top -80}, 1000);
          });

          $('.js--sc-t90a-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--t90a-01').offset().top -60}, 1000);
          });
