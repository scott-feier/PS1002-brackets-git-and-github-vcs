...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          04-03-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
06 Aug 2017   P05          M. Gledhill    Published

04 Aug 2017   d-P04.04.02  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P05</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-040301').click(function () {
           $('html, body').animate({scrollTop: $('#js--040301').offset().top -20}, 1000);
          });

          $('.js--sc-040302').click(function () {
           $('html, body').animate({scrollTop: $('#js--040302').offset().top -20}, 1000);
          });

          $('.js--sc-040303').click(function () {
           $('html, body').animate({scrollTop: $('#js--040303').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f04-13').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-13').offset().top -80}, 1000);
          });

          $('.js--sc-f04-14').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-14').offset().top -80}, 1000);
          });

          $('.js--sc-f04-15').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-15').offset().top -80}, 1000);
          });

          $('.js--sc-f04-16').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-16').offset().top -80}, 1000);
          });

          $('.js--sc-f04-17').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-17').offset().top -80}, 1000);
          });

          $('.js--sc-f04-18').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-18').offset().top -80}, 1000);
          });

          $('.js--sc-f04-19').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-19').offset().top -80}, 1000);
          });

          $('.js--sc-f04-20').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-20').offset().top -80}, 1000);
          });

          $('.js--sc-f04-21').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-21').offset().top -80}, 1000);
          });

          $('.js--sc-f04-22').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-22').offset().top -80}, 1000);
          });

          $('.js--sc-f04-23').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-23').offset().top -80}, 1000);
          });

          $('.js--sc-f04-24').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-24').offset().top -80}, 1000);
          });

          $('.js--sc-f04-25').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-25').offset().top -80}, 1000);
          });

          $('.js--sc-f04-26').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-26').offset().top -80}, 1000);
          });

          $('.js--sc-f04-27').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-27').offset().top -80}, 1000);
          });

          $('.js--sc-f04-28').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-28').offset().top -80}, 1000);
          });

          $('.js--sc-f04-29').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-29').offset().top -80}, 1000);
          });
