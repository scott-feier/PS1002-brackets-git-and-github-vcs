...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          04-02-SCROLL.JS
*******************************************************************************
...
03 Aug 2017   d-P04.04.02  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f04-09').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-09').offset().top -80}, 1000);
          });

          $('.js--sc-f04-10').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-10').offset().top -80}, 1000);
          });

          $('.js--sc-f04-11').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-11').offset().top -80}, 1000);
          });

          $('.js--sc-f04-12').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-12').offset().top -80}, 1000);
          });
