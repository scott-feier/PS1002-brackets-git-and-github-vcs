...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          04-01-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f04-05').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-05').offset().top -80}, 1000);
          });

          $('.js--sc-f04-06').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-06').offset().top -80}, 1000);
          });

          $('.js--sc-f04-07').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-07').offset().top -80}, 1000);
          });

          $('.js--sc-f04-08').click(function () {
           $('html, body').animate({scrollTop: $('#js--f04-08').offset().top -80}, 1000);
          });
