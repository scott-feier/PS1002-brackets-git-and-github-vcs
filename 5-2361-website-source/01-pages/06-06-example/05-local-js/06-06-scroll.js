...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          06-06-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-060600').click(function () {
           $('html, body').animate({scrollTop: $('#js--060600').offset().top -20}, 1000);
          });

          $('.js--sc-060601').click(function () {
           $('html, body').animate({scrollTop: $('#js--060601').offset().top -20}, 1000);
          });

          $('.js--sc-060602').click(function () {
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f06-50').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-50').offset().top -80}, 1000);
          });

          $('.js--sc-f06-51').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-51').offset().top -80}, 1000);
          });

          $('.js--sc-f06-52').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-52').offset().top -80}, 1000);
          });

          $('.js--sc-f06-53').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-53').offset().top -80}, 1000);
          });

          $('.js--sc-f06-54').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-54').offset().top -80}, 1000);
          });

          $('.js--sc-f06-55').click(function () {
           $('html, body').animate({scrollTop: $('#js--f06-55').offset().top -80}, 1000);
          });
