...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                         90c-00-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
11 Sep 2017   P15          M. Gledhill    Published

08 Sep 2017   d-P14.90.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-90c0000').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0000').offset().top -20}, 1000);
          });

          $('.js--sc-90c0100').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0100').offset().top -20}, 1000);
          });

          $('.js--sc-90c0101').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0101').offset().top -20}, 1000);
          });

          $('.js--sc-90c0102').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0102').offset().top -20}, 1000);
          });

          $('.js--sc-90c0103').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0103').offset().top -20}, 1000);
          });

          $('.js--sc-90c0104').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0104').offset().top -20}, 1000);
          });

          $('.js--sc-90c0105').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0105').offset().top -20}, 1000);
          });

          $('.js--sc-90c0106').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0106').offset().top -20}, 1000);
          });

          $('.js--sc-90c0107').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0107').offset().top -20}, 1000);
          });

          $('.js--sc-90c0200').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0200').offset().top -20}, 1000);
          });

          $('.js--sc-90c0201').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0201').offset().top -20}, 1000);
          });

          $('.js--sc-90c0202').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0202').offset().top -20}, 1000);
          });

          $('.js--sc-90c0203').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0203').offset().top -20}, 1000);
          });

          $('.js--sc-90c0204').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0204').offset().top -20}, 1000);
          });

          $('.js--sc-90c0205').click(function () {
           $('html, body').animate({scrollTop: $('#js--90c0205').offset().top -20}, 1000);
          });
