...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          05-04-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
08 Aug 2017   P06          M. Gledhill    Published

07 Aug 2017   d-P05.05.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P06</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-050404').click(function () {
           $('html, body').animate({scrollTop: $('#js--050404').offset().top -20}, 1000);
          });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-f05-20').click(function () {
           $('html, body').animate({scrollTop: $('#js--f05-20').offset().top -80}, 1000);
          });

          $('.js--sc-f05-21').click(function () {
           $('html, body').animate({scrollTop: $('#js--f05-21').offset().top -80}, 1000);
          });

          $('.js--sc-f05-22').click(function () {
           $('html, body').animate({scrollTop: $('#js--f05-22').offset().top -80}, 1000);
          });

          $('.js--sc-f05-23').click(function () {
           $('html, body').animate({scrollTop: $('#js--f05-23').offset().top -80}, 1000);
          });
